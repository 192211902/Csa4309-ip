        ...
        " role="navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    <a href="index.html" class="navbar-brand headerFont text-lg"><strong>E-Voting 2024</strong></a>
                </div>
        ...
        <div class="container" style="padding-top:150px;">
            <div class="row">
                ...
                <div class="col-sm-4 text-center" style="border:2px solid gray;padding:50px;">
                    ...
                    $sql = "INSERT INTO tbl_users (full_name, email, voter_id, voted_for) VALUES ('$name','$email','$voterID','$selection')";
